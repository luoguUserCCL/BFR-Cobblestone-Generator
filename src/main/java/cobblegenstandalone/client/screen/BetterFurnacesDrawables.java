...
public class BetterFurnacesDrawables {
    public static final ResourceLocation WIDGETS = CobblestoneGeneratorMod.createModLocation("textures/container/widgets.png");
    ...
    public static final IFactoryDrawableType VANILLA_BUTTON = IFactoryDrawableType.create(FactoryAPI.createVanillaLocation("textures/gui/widgets.png"), 0, 66, 200, 20);
    public static final IFactoryDrawableType VANILLA_BUTTON_BACKGROUND = IFactoryDrawableType.create(FactoryAPI.createVanillaLocation("textures/gui/widgets.png"), 0, 46, 200, 20);
